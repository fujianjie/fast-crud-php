    ...
    <div class="container-fluid inframe">
                    ...
                    <form class="form-horizontal" method="post" action="/<?php echo $className ?>/index"
                        ...
                        <div class="col-sm-2 text-right">
                                                                        <span class="input-group-btn">
                                                                            ...
                                                                            if (!$emptySearch) {
                                                                            ?>
                                                                            <a class="btn btn-default" title="清除搜索"
                                                                               href="/<?php echo $className ?>/index?clearSearch=1"
                                                                               type="submit"><span
                                                                                        class="glyphicon glyphicon-remove"></span> </a>
                                                                                </span>
            ...
            <li>
                                                <span class="input-group-btn">
                                                                                        <a class="btn btn-default"
                                                                                           ...
                                                                                           href="/<?php echo $className ?>/index?clearSearch=1"
                                                                                           type="submit"> <span
                                                                                                    class="glyphicon glyphicon-remove"></span> 取消搜索</a>
                                                                                </span>
            </li>
            <div class="clearfix"></div>
            <?php
        ...
        <div class="text-right" id="addLinkBlock">
            ...
            if ($searchPageOpen && $searchType == 'key') {
                ...
                if ($searchType == 'searchPage') {
                    ?>
                    <a class="btn btn-danger" title="清除搜索" href="/<?php echo $className ?>/index?clearSearch=1"
                       type="submit"> 清除搜索</a>
                    <?php
                }
                ?>
                ...
                <tr>
                    ...
                    if (count($listKey) > 0) {
                        foreach ($listKey as $v) {
                            if($v == 'typename'){
                                echo "<th class='text-left'>{$keyNameList[$v]}";
                            }else{
                    ...
                    foreach ($listData as $each) {
                        ...
                        foreach ($listKey as $k) {
                            ...
                            if (in_array($k, $keyImportant)) {
                                $important = 'class="text-left important"';
                            }else{
                                if($k == 'typename'){
                                    $important = 'class="text-left"';
                                }
                        ...
                        if ($listOperation) {
                            ...
                            if ($detailOpen) {
                                ...
                                <a href="<?php echo $detailUrl; ?>" class="btn btn-default" title="详细"><span
                                            class="glyphicon glyphicon-search"></span><span class="option"></span></a>
                                <?php
                            }
                            if ($addonButton) {
                            ...
                            if ($editAccess && $editOpen) {
                                ...
                                <a href='<?php echo $editUrl; ?>'
                                   class="btn btn-info" title="编辑"><span class="glyphicon glyphicon-pencil"></span><span
                                            class="option"></span></a>
                                <?php
                            }
                            ...
                            if ($deleteAccess && $removeOpen) {
                                ...
                                <a href="<?php echo $removeUrl; ?>"
                                   ...
                                   title="删除"><span class="glyphicon glyphicon-trash"></span><span
                                            class="option"></span></a>
                                <?php
                            }
                            echo "</td>";
